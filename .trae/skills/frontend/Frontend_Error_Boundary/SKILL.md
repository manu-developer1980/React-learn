---
name: "Skill: Frontend Error Boundary"
description: "Purpose
  Catch errors in the component tree, log them, and render a fallback UI."
---
...
1.  **Create Class Component**: Error Boundaries _must_ be class components (until React adds a hook).
...
- Error Boundaries do _not_ catch errors in: Event handlers, Asynchronous code (setTimeout), Server-side rendering.
